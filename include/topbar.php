...
<!-- top-header -->
	<div class="agile-main-top" style="background-color: #7d1f8e;">
		<div class="container-fluid">
			<div class="row main-top-w3l py-2" style="height: 60px ; background-image:linear-gradient(to right, #8d2bca , #740476);">
				<div class="col-lg-4 header-most-top">
					
				</div>
				<div class="col-lg-8 header-right mt-lg-0 mt-2" style=" margin-left : 830px">
					<!-- header lists -->
					<ul>
			...
			<div class="row header-bot_inner_wthreeinfo_header_mid">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.php" style="color: #7d1f8e;width: 100px">
							<img src="images/computerStar2.png" alt=" " class="img-fluid" style="height: 100px">Computer Star
						</a>
					</h1>
				</div>
				<!-- //logo -->
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
						...
						<div class="col-10 agileits_search">
							<form class="form-inline" action="index.php?quanly=timkiem" method="POST" style="width: 500px;margin-top: 30px">
								...
								<button class="btn my-2 my-sm-0" name="search_button" type="submit" style="background-color:#7d1f8e ">Tìm kiếm</button>
							</form>
						</div>
						<!-- //search -->
						<!-- cart details -->
						<div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
							<div class="wthreecartaits wthreecartaits2 cart cart box_1">
								<form action="#" method="post" class="last">
									...
									<button class="btn w3view-cart" type="submit" name="submit" value=""  style="background-color: #7c1191">
									<a href="index.php?quanly=giohang" ><i class="fas fa-cart-arrow-down" style="color: white " ></i></a>	
									</button>
								</form>
							</div>
						</div>
