							...
							<div class="col-md-12">
								...
								<table class="table table-striped table-dark" style="background-color: #4a2645">
									...
									<tr>
										...
										<td><a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>" class="btn btn-info">Xem chi tiết</a></td>
										<td><?php 
										...
										<td>
											...
											?>
											<a href="index.php?quanly=xemdonhang&khachhang=<?php echo $_SESSION['khachhang_id'] ?>&magiaodich=<?php echo $row_donhang['magiaodich'] ?>&huydon=1" class="btn btn-danger">Yêu cầu hủy</a>
											<?php
