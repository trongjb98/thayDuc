...
<!-- checkout page -->
	<div class="privacy py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 style="font-family: : Palatino ;margin-left: 400px">
				Giỏ hàng của bạn
			</h3>
				<?php 
			...
			?>
				...
				<div class="table-responsive">
					...
					<table class="table table-striped table-dark" style="background-color: #4a2645">
						<thead>
							<tr>
								<th>Thứ tự</th>
								<th>Sản phẩm</th>
						...
						?>
							<tr class="rem1">
								...
								<td class="invert">
									<a href="?quanly=giohang&xoa=<?php echo $row_fetch_giohang['giohang_id'] ?>" class="btn btn-danger" >Xóa</a>
								</td>
							</tr>
							<?php
							} 
			...
			if(!isset($_SESSION['dangnhap_home'])){ 
			?>
			<div class="checkout-left" style="background-color:#4a2645 ">
				<div class="address_form_agile mt-sm-5 mt-4">
					<h4 class="mb-sm-4 mb-3" style="margin-left: 100px">Thêm địa chỉ giao hàng</h4>
					<form action="" method="post" class="creditly-card-form agileinfo_form" style="width: 600px;margin-left: 50px">
