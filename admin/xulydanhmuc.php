			...
			<div class="col-md-8">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>
						 <a  class="btn btn-primary" href="?quanly=capnhat&id=<?php echo $row_category['category_id'] ?>">Cập nhật</a>
						</td>
						<td>
			             <a class="btn btn-danger" href="?xoa=<?php echo $row_category['category_id'] ?>">Xóa</a>
