			...
			<div class="col-md-8">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>
							<a type="button" class="btn btn-primary" href="xulybaiviet.php?quanly=capnhat&capnhat_id=<?php echo $row_bv['baiviet_id'] ?>">Cập nhật</a>
						</td>
							<td>

							<a type="button" class="btn btn-danger"  href="?xoa=<?php echo $row_bv['baiviet_id'] ?>">Xóa</a> 
						</td>
					</tr>
				<?php
					} 
