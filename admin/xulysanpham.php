	...
	<div class="container">
		...
		<?php
			...
			<div class="col-md-8">
				...
				<?php
				$sql_select_sp = mysqli_query($con,"SELECT * FROM tbl_sanpham,tbl_category WHERE tbl_sanpham.category_id=tbl_category.category_id ORDER BY tbl_sanpham.sanpham_id DESC limit 0 ,6"); 
				?> 
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>							 
							 <a type="button" class="btn btn-primary" href="xulysanpham.php?quanly=capnhat&capnhat_id=<?php echo $row_sp['sanpham_id'] ?>">update</a>
							</td>
							 <td>
							<a type="button" class="btn btn-danger" href="?xoa=<?php echo $row_sp['sanpham_id'] ?>">Xóa</a>
			         	</tr>
					   </tr>
