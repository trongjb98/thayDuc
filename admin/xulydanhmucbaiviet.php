			...
			<div class="col-md-8">
				...
				<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<td>
						 <a type="button" class="btn btn-primary" href="?quanly=capnhat&id=<?php echo $row_category['danhmuctin_id'] ?>">Cập nhật</a>
						</td>
							<td>
						 <a type="button" class="btn btn-danger"  href="?xoa=<?php echo $row_category['danhmuctin_id'] ?>">Xóa</a> 
						</td>
					</tr>
					<?php
					} 
